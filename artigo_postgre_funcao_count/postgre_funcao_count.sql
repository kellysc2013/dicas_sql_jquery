/**
*DESCOMENTE O COMANDO ABAIXO SOMENTE SE DESEJAR EXCLUIR A TABELA tb_ordem_servicov 
*/
...
/**
*Ordenar o serviço por ordem alfabética 
*/
SELECT
cod_servico,
COUNT(cod_servico) AS quantidade
...
/**
*Para ordenar por ano e mês em ordem crescente utilize o comando "ORDER BY".
*/
SELECT
...
/**
*Para não exibir a coluna "ordem_data" você pode montar uma subquery. 
*/
