...
/**
*Exibe o imóvel com valor mais baixo
*/
SELECT MIN(valor) FROM tb_imoveis;

/**
*Criação do alias imovel_valor_minimo
*/
...
/**
* Qual foi o pior treino para cada atleta, ou seja, qual corrida levou menor tempo.
...
/**
*Também podemos utilizar a função "MIN" para filtrar um registro, 
*desde que a função "MIN" pertença a uma subquery. 
*/
SELECT 
atleta_id,   
data, 
